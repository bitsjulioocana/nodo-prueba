...
module.exports = {
  listTeamsByCountry: listTeamsByCountry,
  sortTeamsByWins: sortTeamsByWins,
  leaguesWithWins: leaguesWithWins,
  leaguesWithTeamWithLestWins: leaguesWithTeamWithLestWins,
  leaguesWithTeamWithMostWins: leaguesWithTeamWithMostWins,
  sortLeaguesByTeamsByWins: sortLeaguesByTeamsByWins,
  sortLeaguesByTeams: sortLeaguesByTeams,
  newTeamRanking: newTeamRanking,
  getTeamsNamesAsUpperCase: getTeamsNamesAsUpperCase
};
